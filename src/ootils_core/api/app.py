...
from ootils_core.api.routers import bom, calc, calendars, dq, events, explain, ghosts, graph, ingest, issues, mrp, planning_params, projection, rccp, scenarios, simulate, mps, demand, atp
...
def create_app() -> FastAPI:
    ...
    application.include_router(mps.router)
    application.include_router(demand.router)
    application.include_router(atp.router)
